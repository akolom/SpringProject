...
import edu.mum.ezstore.exception.AuthenticationException;
import edu.mum.ezstore.exception.AuthorizationException;
import edu.mum.ezstore.exception.BusinessException;
import edu.mum.ezstore.exception.InvalidArgumentsException;
import edu.mum.ezstore.exception.MaximumRequestsLimitException;
import edu.mum.ezstore.exception.ObjectAlreadyExistsException;
import edu.mum.ezstore.exception.ObjectNotFoundException;
import edu.mum.ezstore.exception.ObjectStateChangedSinceLastRequestException;
